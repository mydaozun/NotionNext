...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'daozun', // 您的昵称 例如 kid1412
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的摸鱼划水的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://bk.52cbg.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || '838325042@qq.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  MUSIC_PLAYER_METING_ID:
        process.env.NEXT_PUBLIC_MUSIC_PLAYER_METING_ID || '7760919557', // 对应歌单的 id
